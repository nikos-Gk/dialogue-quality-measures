...
final = """\n\n
Given a conversation history (which can be empty if the new utterance is the first utterance made in the conversation), please analyze a new utterance from a user (identified by a unique user_id) in a conversation discussing with others about this potentially controversial post on a social media site.
Post: {post} 
