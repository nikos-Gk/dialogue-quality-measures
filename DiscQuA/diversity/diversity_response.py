...
def diversity_response(
    ...
    Returns:
       ...
       diversity scores, where each message ID is assigned a numeric score.
    """
    ...
    try:
        ...
        dprint(
            "info",
            f"Diversity Score Per Response-Proccessing discussion: {disc_id} with LLM",
        )
