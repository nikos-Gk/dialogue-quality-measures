...
For clarity, your evaluation should be presented with the statement: 'The engagement score of the new response is: [X]', where X is the numeric score you've determined. 
