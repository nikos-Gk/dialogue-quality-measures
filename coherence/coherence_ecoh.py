...
for disc in discussions:
    results,context_list,response_list, conversation_id = processDiscussion(disc)
...
with open('discussion_turnlevel_agresults_'+timestr+'.json', 'w',encoding="utf-8") as fout:
      json.dump(aggregate_results, fout, ensure_ascii=False, indent=4) 

with open('discussion_turnlevel_reasons_'+timestr+'.json', 'w',encoding="utf-8") as fout:
      json.dump(reasons, fout, ensure_ascii=False, indent=4) 

with open('discussion_turnlevel_boolean_results_'+timestr+'.json', 'w',encoding="utf-8") as fout:
...
average_coherence_per_discussion.append({"aggregate_mean":mean_values.to_dict()[0]})

with open('discussion_echo_results_'+timestr+'.json', 'w',encoding="utf-8") as fout:
